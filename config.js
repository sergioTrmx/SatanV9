...
module.exports = kconfig = async (kill, message) => {
    ...
    break
	    ...
	    case 'Sergio🦠':
			if (mute) return console.log('Ignorando comando [Silence]')
    await kill.reply(from, '｡☆✼★━━━━━━━━━━━━★✼☆｡\n\nHola!😀\n\nTe gustaria apoyarme?\n\nSolo unete a mi grupo de WhatsApp: https://chat.whatsapp.com/HXr3jVDApfQEeoA71ACnNa* ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ►*\n\nO tambien puedes seguirte en instagram: https://www.instagram.com/p/CL_ViouF8IU/?igshid=82vfgsunrqoq✩｡:*•.─────  ❁ ❁  ─────.•*:｡✩\n\nO sec', id)
    break	
