...
module.exports = kconfig = async (kill, message) => {
	...
	const chats = (type === 'chat') ? body : (type === 'image' || type === 'video') ? caption : ''
        const ownerNumber = '50372488366@c.us' // MUDE ISSO PARA O SEU NUMERO
...
if (isMedia) {
	...
	case 'upimg':
		...
		case 'legiao':
			...
			kill.sendLinkWithAutoPreview(from, 'https://wa.me/+50372488366', 'Genial que te hayas interesado en contactar a satan!\nAqui esta su whats!', id)
			break
	...
	case 'get':
        ...
        case 'criador':
            kill.sendContact(from, '50373488366')
		...
		case 'doar':
            ...
            kill.sendContact(from, 'wa.me/+50373488366')
            break
