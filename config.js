...
module.exports = kconfig = async (kill, message) => {
    ...
    break
	    ...
	    case 'samu330':
			if (mute) return console.log('Ignorando comando [Silence]')
    await kill.reply(from, '｡☆✼★━━━━━━━━━━━━★✼☆｡\n\nHola!😀\n\nTe gustaria apoyarme?\n\nSolo unete a mi grupo de WhatsApp: https://chat.whatsapp.com/JyD8Vj11LPu1TofWhWnYMA\n\n* ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ► ◄ ◊ ►*\n\nO puedes suscribirte a mi canal para saber como instalar un Bot: https://www.youtube.com/channel/UC8yq2vREgBFz5Vi_51QNX9g\n\n✩｡:*•.─────  ❁ ❁  ─────.•*:｡✩\n\nO seamos amigos en facebook: https://facebook.com/netomembreno', id)
    break	
